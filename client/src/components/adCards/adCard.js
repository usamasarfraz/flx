...

            {
                ...
                return<Card key={item._id} className={classes.card}>
                    ...
                    <CardActions>
                        ...
                        <Grid item xs={2}>
                        {this.checkChecked(item) && this.props.login.signin?<FormControlLabel
                            control={
...
const newMediaCard = connect(recieveData)(MediaCard);

export default withStyles(styles)(newMediaCard);